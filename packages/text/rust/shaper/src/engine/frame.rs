...
pub(crate) const SEMANTIC_F32_FOREGROUND_RED: u8 = 6;
pub(crate) const SEMANTIC_F32_FOREGROUND_GREEN: u8 = 7;
pub(crate) const SEMANTIC_F32_FOREGROUND_BLUE: u8 = 8;
pub(crate) const SEMANTIC_F32_FOREGROUND_ALPHA: u8 = 9;
pub(crate) const SEMANTIC_F32_INVERSE_FONT_SIZE: u8 = 10;
