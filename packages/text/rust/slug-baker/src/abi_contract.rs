...
pub fn json() -> String {
    json!({
        ...
        "segmented": {
            ...
            "functions": {
                "status": { "export": "pmndrs_text_slug_segmented_status", "parameters": [], "result": "status" },
                "metadataPointer": { "export": "pmndrs_text_slug_segmented_metadata_ptr", "parameters": [], "result": "pointer" },
                "metadataByteLength": { "export": "pmndrs_text_slug_segmented_metadata_len", "parameters": [], "result": "byteLength" },
                "artifactCount": { "export": "pmndrs_text_slug_segmented_artifact_count", "parameters": [], "result": "count" },
                "artifactByteLength": { "export": "pmndrs_text_slug_segmented_artifact_len", "parameters": ["artifactIndex"], "result": "byteLength" },
                "chunkPointer": { "export": "pmndrs_text_slug_segmented_chunk_ptr", "parameters": ["artifactIndex", "byteOffset"], "result": "pointer" },
                "chunkByteLength": { "export": "pmndrs_text_slug_segmented_chunk_len", "parameters": ["artifactIndex", "byteOffset"], "result": "byteLength" },
                "release": { "export": "pmndrs_text_slug_segmented_release", "parameters": [] },
            },
        },
        "versions": {
