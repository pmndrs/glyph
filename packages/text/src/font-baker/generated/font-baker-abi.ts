...
export const fontBakerAbi = {
  ...
  functions: {
    ...
    bake: {
      ...
      parameters: ['sourcePointer', 'sourceByteLength', 'descriptorPointer', 'descriptorByteLength'],
    ...
    prepare: {
      ...
      parameters: ['sourcePointer', 'sourceByteLength', 'selectionPointer', 'selectionByteLength'],
      result: 'responsePointer',
    },
    responseByteLength: {
