...
const wasmOpt = fileURLToPath(
  new URL(
    process.platform === 'win32' ? '../node_modules/.bin/wasm-opt.CMD' : '../node_modules/.bin/wasm-opt',
    import.meta.url,
  ),
);
...
await writeFile(new URL('../dist/font-baker-abi-v0.json', import.meta.url), abiJson);
