...
export async function runFuzz(arguments_: readonly string[]): Promise<void> {
  ...
  switch (command) {
    case 'validator':
      ...
      await runNode('scripts/font-baker/fuzz-validator.mjs', rest);
      return;
    case 'rust':
      await runNode('scripts/font-baker/fuzz-rust.mjs', rest);
      return;
    case 'mtsdf':
      await runNode('scripts/font-baker/fuzz-rust.mjs', ['mtsdf_outline', ...rest]);
      return;
    case 'mutation':
      await runNode('scripts/font-baker/fuzz-rust-mutation.mjs', rest);
      return;
    default:
