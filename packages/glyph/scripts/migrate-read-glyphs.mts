/* @workflow {
  "name": "glyph:read-glyphs:migrate",
  "summary": "Preview the archived withGlyphs-to-readGlyphs migration; pass --write to apply it.",
...
/* @workflow {
  "name": "glyph:read-glyphs:codemod-test",
  "summary": "Verify the readGlyphs migration against repository and installed-consumer fixtures.",
  "requirements": "Pinned ts-morph and workspace dependencies.",
...
const recipe = new URL('../../../.agents/skills/codemod/codemods/2026-09-24-read-glyphs/', import.meta.url);
