...
export const slugBakerAbi = {
  ...
  "segmented": {
    ...
    "functions": {
      "artifactByteLength": {
        "export": "pmndrs_glyph_slug_segmented_artifact_len",
        "parameters": [
          "artifactIndex"
        ],
        "result": "byteLength"
      ...
      "artifactCount": {
        "export": "pmndrs_glyph_slug_segmented_artifact_count",
        "parameters": [],
        "result": "count"
      },
      "chunkByteLength": {
        "export": "pmndrs_glyph_slug_segmented_chunk_len",
        "parameters": [
          "artifactIndex",
          "byteOffset"
        ],
      ...
      "chunkPointer": {
        "export": "pmndrs_glyph_slug_segmented_chunk_ptr",
        "parameters": [
          "artifactIndex",
          "byteOffset"
        ],
      ...
      "metadataByteLength": {
        "export": "pmndrs_glyph_slug_segmented_metadata_len",
        "parameters": [],
        "result": "byteLength"
      },
      "metadataPointer": {
        "export": "pmndrs_glyph_slug_segmented_metadata_ptr",
        "parameters": [],
        "result": "pointer"
      },
      "release": {
        "export": "pmndrs_glyph_slug_segmented_release",
        "parameters": []
      },
      "status": {
        "export": "pmndrs_glyph_slug_segmented_status",
        "parameters": [],
        "result": "status"
      }
    },
