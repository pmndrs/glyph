import { f32, policyProgram, u32, type PolicyF32Value, type PolicyU32Value } from '../../dist/core.js';
...
p.storeF32(1, [left, top, f32.mul(width, fontSize), f32.mul(height, fontSize)]);
p.storeF32(2, [color.red, color.green, color.blue, color.alpha]);
p.storeF32(3, [u32.toF32(page), f32.const(0), f32.const(0), f32.const(0)]);
