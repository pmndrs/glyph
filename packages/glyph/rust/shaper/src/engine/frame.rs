...
pub(crate) const DROP_CAP_ALIGN_TEXT_TOP: u8 = 1;
pub(crate) const DROP_CAP_ALIGN_BASELINE: u8 = 2;
pub(crate) const DROP_CAP_SIDE_INLINE_START: u8 = 1;
pub(crate) const DROP_CAP_SIDE_INLINE_END: u8 = 2;
