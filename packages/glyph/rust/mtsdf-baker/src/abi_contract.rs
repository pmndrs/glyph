...
pub fn json(include_artifact_baker: bool) -> String {
    let mut contract = json!({
        ...
        "memory": "memory",
        "functions": {
            "allocate": "pmndrs_glyph_mtsdf_alloc",
            "deallocate": "pmndrs_glyph_mtsdf_dealloc",
            "generate": "pmndrs_glyph_mtsdf_generate",
            "resultPointer": "pmndrs_glyph_mtsdf_result_ptr",
            "resultLength": "pmndrs_glyph_mtsdf_result_len"
        },
        "layouts": {
            "request": {
    ...
    if include_artifact_baker {
        ...
        contract["artifactBaker"] = json!({
            ...
            "functions": {
                "bake": {
                    "export": "pmndrs_glyph_mtsdf_bake",
                    "parameters": ["sourcePointer", "sourceByteLength", "requestPointer", "requestByteLength"],
                    "result": "responsePointer",
                },
                "responseByteLength": {
                    "export": "pmndrs_glyph_mtsdf_bake_result_len",
                    "parameters": [],
                    "result": "byteLength",
                },
                "segmentedStatus": {
                    "export": "pmndrs_glyph_mtsdf_segmented_status",
                    "parameters": [],
                    "result": "status",
                },
                "segmentedMetadataPointer": {
                    "export": "pmndrs_glyph_mtsdf_segmented_metadata_ptr",
                    "parameters": [],
                    "result": "pointer",
                },
                "segmentedMetadataByteLength": {
                    "export": "pmndrs_glyph_mtsdf_segmented_metadata_len",
                    "parameters": [],
                    "result": "byteLength",
                },
                "segmentedArtifactCount": {
                    "export": "pmndrs_glyph_mtsdf_segmented_artifact_count",
                    "parameters": [],
                    "result": "count",
                },
                "segmentedArtifactByteLength": {
                    "export": "pmndrs_glyph_mtsdf_segmented_artifact_len",
                    "parameters": ["artifactIndex"],
                    "result": "byteLength",
                },
                "segmentedChunkPointer": {
                    "export": "pmndrs_glyph_mtsdf_segmented_chunk_ptr",
                    "parameters": ["artifactIndex", "byteOffset"],
                    "result": "pointer",
                },
                "segmentedChunkByteLength": {
                    "export": "pmndrs_glyph_mtsdf_segmented_chunk_len",
                    "parameters": ["artifactIndex", "byteOffset"],
                    "result": "byteLength",
                },
                "releaseSegmentedResponse": {
                    "export": "pmndrs_glyph_mtsdf_segmented_release",
                    "parameters": [],
                },
            },
            "response": {
