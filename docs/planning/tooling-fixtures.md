...
| GLB-to-HarfRust registration | 🟡 | Canonical Inter is independently validated, registered through `FontRegistry`, and contributes exactly its retained 147,192-byte SFNT, 23,496-byte extents, and 368-byte availability views to the Wasm shaper. Exact batch output comparison remains item 4.2. |
