...
Status: 🟡 roadmap items 3.1 probing/registration and 3.2 default module-Worker fallback are complete; item 3.3 parity/cancellation/package evidence is active
