...
describe.sequential('runtime repository gates', () => {
  ...
  gate('stable Three raster browser proof', () => runNodeScript('scripts/verify-v1-bitmap.mts'));
  gate('TypeGPU Three raster browser proof', () => runNodeScript('scripts/verify-v1-bitmap.mts', ['--typegpu']));
