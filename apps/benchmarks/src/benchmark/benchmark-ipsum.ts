...
export const BENCHMARK_IPSUM_PARAGRAPHS = [
  ...
  'A practical interface mixes prose with 0123456789, prices such as 24.50, ranges from 8–96 px, and punctuation—“quotes”, (parentheses), brackets, commas, and semicolons. Repeated office, affine, difficult, and shuffle words retain ff, fi, fl, ffi, and ffl candidates without claiming that every font substitutes them.',
...
export const BENCHMARK_IPSUM_INTER_GLYPH_COUNT = 1_150
