...
import { chromiumExecutablePathEnvironmentVariable, projectChromiumLaunchOptions } from './project-chromium.mts';
...
test('rejects an empty configured Chromium executable', () => {
  assert.throws(
    () => projectChromiumLaunchOptions({ headless: true }, { [chromiumExecutablePathEnvironmentVariable]: '   ' }),
