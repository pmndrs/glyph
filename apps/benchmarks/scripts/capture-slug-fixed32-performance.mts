...
const output = new URL('../fixtures/autoresearch/slug-fixed32-bands-001/performance-chromium149.json', import.meta.url);
const child = spawn(executable, ['--gpu', '--path', '/?runner=probe', './vitexec/slug-fixed32-performance.probe.ts'], {
  cwd,
