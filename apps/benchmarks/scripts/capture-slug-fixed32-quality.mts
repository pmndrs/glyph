...
const output = new URL('../fixtures/autoresearch/slug-fixed32-bands-001/quality-chromium149.json', import.meta.url);
const child = spawn(executable, ['--gpu', '--path', '/?runner=probe', './vitexec/slug-fixed32-quality.probe.ts'], {
  cwd,
