...
const output = new URL('../fixtures/results/icon-grid-retained-evidence-chromium149.json', import.meta.url);
const child = spawn(
  executable,
  [
    '--gpu',
...
function assertObservation(candidate: unknown): asserts candidate is Record<string, unknown> {
  ...
  if (
    provenance.catalogPath !== 'apps/benchmarks/fixtures/fonts/font-awesome-free-6.7.2/icons.json' ||
    provenance.catalogFixtureSha256 !== '1619fee77e078bc015218bd2c0ac0ae045c307b843bd09dba99c52e20ae5079d' ||
    ...
    provenance.catalogSourceSha256 !== 'a3a705d0e03c4fbdf1a61aece3d8fd462024b33794187ef7ee2a0764439170eb' ||
    provenance.fontPath !== 'apps/benchmarks/fixtures/fonts/font-awesome-free-6.7.2/fa-solid-900.ttf' ||
