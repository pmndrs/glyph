...
export function PrepareCameo() {
  const required = ['robot', 'dust', 'icons:0.012', 'icons:0.026'];
  ...
  useFrame(
    ...
    { id: 'cameo-render', phase: 'render', fps: 60 },
  );
