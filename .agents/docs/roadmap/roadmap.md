...
cutover, browser pixels, release size, and performance closure. Fresh-main evidence is positive for ordinary Latin,
justified Latin, dense CJK, and mixed bidi after lazy absolute semantic materialization removed width-only semantic
rewrites. Final two-pass candidate medians are `1.562`, `2.229`, `2.277`, and `3.437 ms` respectively; mixed bidi is
13.0% faster than the recorded fresh-main median. The remaining gate is the complete browser/editorial matrix. The
