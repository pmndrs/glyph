...
sources:
  ...
  - id: presentation-playback
    resource: ../../../benches/src/controllers/presentation-playback.tsx
    title: Presentation keyboard and timed-playback controller
  - id: workload-controls
    resource: ../../../benches/src/components/workload-controls.tsx
    title: Live workload and shaping controls
  - id: payload-inspector
    resource: ../../../benches/src/components/payload-inspector.tsx
