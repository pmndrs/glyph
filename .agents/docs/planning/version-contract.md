...
sources:
  - id: glyph-manifest
    ...
    title: Node discovery dependency pins
  - id: harfrust
...
| Discovery syntax                      | `oxc-parser` `0.150.0`                                                            | Native Node parser and typed ESTree AST; no application type checking                                                                                     |
| Discovery lexical scopes              | `oxc-walker` `1.1.1`                                                              | Two-pass declaration/reference resolution; no application execution                                                                                       |
| Discovery module resolution           | `oxc-resolver` `11.24.2`                                                          | Node-only ESM, tsconfig paths, and source extension resolution                                                                                            |
...
| `PMNDRS_font` format                  | `0`; `1` only for a font that carries outlines                                    | extension schema, shaping contract, and D-371 outlines                                                                                                    |
...
| Static discovery dependencies | JS/JSX/TS/TSX fixtures, scope and imported-constant cases, and isolated packed CLI baking without TypeScript installed.                                                                           |
